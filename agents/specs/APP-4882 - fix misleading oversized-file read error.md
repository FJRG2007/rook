...
Originating thread: https://rook-public.slack.com/archives/C0BDQDW8V5E/p1784468227182559
Estimate: M (3)

## Reconciliation with master (rebased)
This spec was originally written against `FJRG2007/rook@69ce372`, where the
