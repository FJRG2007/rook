...
- [ ] No performance regression on dev. See [dashboard](https://rook.metabaseapp.com/dashboard/1519-dev-performance-by-version?shell=zsh)
...
- [ ] [Telemetry entry](https://docs.rook.dev/getting-started/privacy#exhaustive-telemetry-table) (if applicable)
