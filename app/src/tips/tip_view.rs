    ...
    pub fn new(
        ...
        let tip_items = vec![
            TipItem::new(
                ...
                "Easily discover everything you can do in Rook without your hands leaving the keyboard.".to_string(),
            ...
            TipItem::new(
                ...
                "Make Rook your own by choosing a built-in theme. Or create your own.".to_string(),
