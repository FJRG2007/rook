...
use rookui::{AppContext, EntityId, SingletonEntity, ViewContext, ViewHandle, WindowId};
...
pub(super) struct WorkspaceMouseStates {
    ...
    pub(super) rook_logo: MouseStateHandle,
}
...
/// that.
///
/// Note that "active" is not the same as "focused" in Rook's pane management.
