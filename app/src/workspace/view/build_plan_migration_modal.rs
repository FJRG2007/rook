...
impl BuildPlanMigrationModal {
    ...
    fn render_auto_reload_controls(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let dropdown = if self.auto_reload_enabled {
            ...
            ConstrainedBox::new(rookui::elements::Empty::new().finish())
...
impl BuildPlanMigrationModal {
    ...
    fn render_left_panel(&self, appearance: &Appearance, app: &AppContext) -> Box<dyn Element> {
        ...
        let intro_text = if is_business {
            "Your workspace has been updated to the new Rook Business Plan as the legacy Business plan is sunset."
        } else {
            "Your workspace has been updated to the Rook Build Plan as the legacy Pro, Turbo, and Lightspeed plans are sunset."
        };
        ...
        let pricing_header = Self::create_text(
            if is_business {
                ...
                "Rook Build is a primarily usage-based plan, starting at:"
            }
            .to_string(),
            font_family,
            14.,
        ...
        let learn_more_fragments = vec![
            ...
            FormattedTextFragment::hyperlink("pricing page", "https://www.rook.dev/pricing"),
