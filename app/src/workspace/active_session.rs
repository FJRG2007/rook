...
use rookui::{Entity, EntityId, ModelContext, SingletonEntity, WindowId};
...
/// in Rook from Finder, or when starting from a cloud object). In that case, the `ActiveSession`
