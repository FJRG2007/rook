...
impl rookui::Entity for TestView {
    type Event = ();
}

impl rookui::View for TestView {
    fn render(&self, _: &rookui::AppContext) -> Box<dyn rookui::Element> {
        Empty::new().finish()
    }
...
impl rookui::TypedActionView for TestView {
    type Action = ();
}
