...
//!   through [`rook_errors::report_error!`] or code-review telemetry keeps logs,
...
use rook_core::sync_queue::IsTransientError;
use rook_errors::{AnyhowErrorExt, ErrorExt};
...
rook_errors::register_error!(DiffStateError);
