...
impl UpdateEnvironmentForm {
            ...
            move |me, result, ctx| {
                ...
                match result {
                    Ok(result) => match result {
                        rook_graphql::queries::suggest_cloud_environment_image::SuggestCloudEnvironmentImageResult::SuggestCloudEnvironmentImageOutput(output) => {
                        ...
                        rook_graphql::queries::suggest_cloud_environment_image::SuggestCloudEnvironmentImageResult::SuggestCloudEnvironmentImageAuthRequiredOutput(output) => {
                        ...
                        rook_graphql::queries::suggest_cloud_environment_image::SuggestCloudEnvironmentImageResult::UserFacingError(_) => {
                        ...
                        rook_graphql::queries::suggest_cloud_environment_image::SuggestCloudEnvironmentImageResult::Unknown => {
                ...
                Container::new(
                    Flex::row()
                        ...
                        .with_child(
                            ConstrainedBox::new(
                                Icon::Github
                                    .to_rookui_icon(theme.active_ui_text_color())
                                    .finish(),
                            )
    ...
    fn render_docker_image_suggest_button(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let tooltip_text = "Rook will suggest a Docker image based on your selected repositories.";
        ...
        let button = Hoverable::new(
            ...
            move |state| {
                ...
                let icon_size = appearance.ui_font_size();
                let icon = ConstrainedBox::new(Icon::Lightbulb.to_rookui_icon(text_fill).finish())
                    .with_width(icon_size)
                    .with_height(icon_size)
                    .finish();
...
impl TypedActionView for UpdateEnvironmentForm {
    ...
    ) -> rookui::accessibility::ActionAccessibilityContent {
        rookui::accessibility::ActionAccessibilityContent::default()
    }
}
