...
impl BlockClient for ServerApi {
    ...
    async fn blocks_owned_by_user(&self) -> Result<Vec<Block>, anyhow::Error> {
        ...
        match response.user {
            rook_graphql::queries::get_blocks_for_user::UserResult::UserOutput(user_output) => {
                Ok(user_output
                    .user
                    .blocks
                    .into_iter()
            ...
            rook_graphql::queries::get_blocks_for_user::UserResult::Unknown => {
