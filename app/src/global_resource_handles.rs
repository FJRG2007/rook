...
use rookui::{Entity, ModelHandle, SingletonEntity};
...
///   One example use case could be receiving updates from the rook config watcher
...
impl GlobalResourceHandles {
    ...
    pub fn mock(app: &mut rookui::App) -> Self {
