...
use rookui::ui_components::button::{ButtonTooltipPosition, ButtonVariant};
...
pub(crate) fn render_action_sidecar(
    ...
    let button_style = UiComponentStyles {
        ...
        padding: Some(rookui::ui_components::components::Coords {
            top: 4.,
            bottom: 4.,
            left: 8.,
            right: 8.,
    ...
    let make_default_button = if is_already_default {
        ...
        appearance
            ...
            .on_click(move |ctx: &mut rookui::elements::EventContext, _, _| {
