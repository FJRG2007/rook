...
fn main() -> Result<()> {
    let config = rook_channel_config::load_config!("local");
...
embed_plist::embed_info_plist_bytes!(r#"
    ...
    <string>RookLocal</string>
    <key>CFBundleExecutable</key>
    <string>rook</string>
    <key>CFBundleIdentifier</key>
    <string>dev.rook.Rook-Local</string>
    ...
    <array><dict><key>CFBundleURLName</key><string>Custom App</string><key>CFBundleURLSchemes</key><array><string>rooklocal</string></array></dict></array>
