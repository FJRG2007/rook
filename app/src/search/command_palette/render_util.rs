...
use rookui::Element;
use rookui::elements::{Align, ConstrainedBox, Container, Empty};
...
pub fn render_search_item_icon(
    ...
    let icon_element = icon.to_rookui_icon(Fill::Solid(icon_color)).finish();
...
pub mod colors {
    pub const ROOK_AI: u32 = 0xF3B911FF;
}
