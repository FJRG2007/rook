...
static DEFAULT_TIPS: LazyLock<Vec<AgentTip>> = LazyLock::new(|| {
    vec![
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/agents/capabilities/slash-commands".to_string()),
            binding_name: None,
            action: None,
        ...
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/terminal/input/universal-input#input-modes".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/agents/capabilities/planning".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::SlashCommands,
        },
        AgentTip {
            description: "<keybinding> to open the Command Palette and access Rook actions and shortcuts.".to_string(),
            link: Some("https://docs.rook.dev/terminal/command-palette".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/knowledge-and-collaboration/rook-drive".to_string()),
            binding_name: None,
            action: Some(WorkspaceAction::OpenRookDrive),
            kind: AgentTipKind::RookDrive,
        },
        AgentTip {
        ...
        AgentTip {
            description: "`@` to add context from files, blocks, or Rook Drive objects to your prompt.".to_string(),
            link: Some("https://docs.rook.dev/agents/local-agents/agent-context/using-to-add-context".to_string()),
            binding_name: None,
            action: None,
        ...
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/agents/local-agents/agent-context/blocks-as-context#attaching-blocks-as-context".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/agents/capabilities/codebase-context".to_string()),
            binding_name: None,
            action: None,
        ...
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/agents/capabilities/agent-profiles-permissions".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/agents/local-agents/interacting-with-agents/conversation-forking".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/terminal/blocks/block-actions#copy-input-output-of-block".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/agents/local-agents/agent-context/images-as-context".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::Context,
        },
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/agents/capabilities/full-terminal-use".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/code/code-review".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/agents/capabilities/mcp".to_string()),
            binding_name: None,
            action: None,
        ...
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/reference/cli/integration-setup".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        ...
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/agents/capabilities/rules".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::Context,
        },
        ...
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/agents/local-agents/interacting-with-agents".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::SlashCommands,
        },
        ...
        AgentTip {
            description: "Use the `oz` command to run the Rook Agent in headless mode, useful for remote machines.".to_string(),
            link: Some("https://docs.rook.dev/reference/cli".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        ...
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/agents/capabilities/rules#project-rules-1".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::Context,
        },
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/agents/local-agents/agent-context/urls-as-context".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::Context,
        },
        AgentTip {
            description: "Rookify a remote SSH session to enable the Rook Agent inside that environment.".to_string(),
            link: Some("https://docs.rook.dev/terminal/rookify".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        ...
        AgentTip {
            description: "`/init` to generate a `ROOK.md` file and define project rules for the agent.".to_string(),
            link: Some("https://docs.rook.dev/agents/capabilities/rules".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::SlashCommands,
        ...
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/agents/capabilities/full-terminal-use#session-level-approvals".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://docs.rook.dev/platform/managing-cloud-agents#in-app-agent-notifications".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
...
impl WorkspaceAction {
    pub fn display_text(&self) -> Option<String> {
        match self {
            ...
            WorkspaceAction::OpenRookDrive => Some("Rook Drive.".to_string()),
        ...
        && AISettings::as_ref(ctx).is_voice_input_enabled(ctx)
    {
        tips.push(AgentTip {
            description: "Hold <keybinding> to speak your prompt directly to the agent."
                .to_string(),
            link: Some(
                "https://docs.rook.dev/agents/local-agents/interacting-with-agents/voice"
                    .to_string(),
            ),
