...
/// Tracks and stores notifications for both rook agent conversations and other supported
/// cli agent sessions.
...
pub enum AgentManagementEvent {
    /// A Rook-native conversation needs attention and is not visible in the current window/tab.
