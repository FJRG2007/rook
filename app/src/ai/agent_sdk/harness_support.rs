//! `rook harness-support` CLI dispatch and the singleton model all subcommands run async work on.
//!
//! Subcommands:
...
use rookui::{AppContext, ModelHandle, SingletonEntity};
...
impl rookui::Entity for HarnessSupportRunner {
    type Event = ();
}
