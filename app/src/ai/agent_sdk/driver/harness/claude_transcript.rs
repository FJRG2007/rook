...
//!   Claude conversation: the Rook server conversation id to reuse, the Claude session uuid
...
pub(crate) struct ClaudeResumeInfo {
    /// The Rook server-side conversation id. The runner stores this instead of calling
