...
const DEFAULT_LEARN_MORE_URL: &str = "https://docs.rook.dev/platform/harnesses/authentication/";
const CODEX_LEARN_MORE_URL: &str =
    "https://docs.rook.dev/platform/harnesses/authentication/#connecting-codex-credentials";
const CLAUDE_LEARN_MORE_URL: &str =
    "https://docs.rook.dev/platform/harnesses/authentication/#connecting-claude-code-credentials";
