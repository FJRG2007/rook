//! This module contains Rust types for the PredictAMQueries endpoint in rook-server that
//! serves Agent Mode.
//!
//! These types are manually transposed from the API schema defined in go
//! (rook-server/model/types/predict_am_queries/(request.go|response.go|common.go)).
//!
