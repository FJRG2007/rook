//! This module contains Rust types for the GenerateAIInputSuggestions endpoint in rook-server that
//! serves Agent Mode.
//!
//! These types are manually transposed from the API schema defined in go
//! (rook-server/model/types/generate_ai_input_suggestions/(request.go|response.go|common.go)).
//!
