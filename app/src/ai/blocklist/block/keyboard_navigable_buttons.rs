...
pub type ButtonBuilder = Box<dyn Fn(bool, &rookui::AppContext) -> Button>;
...
impl KeyboardNavigableButtonBuilder {
    pub fn new(
        button_builder: impl Fn(bool, &rookui::AppContext) -> Button + 'static,
...
pub fn simple_navigation_button<A: rookui::Action + Clone + 'static>(
    text_label: String,
...
pub fn rich_navigation_button<A: rookui::Action + Clone + 'static>(
    text_label: String,
