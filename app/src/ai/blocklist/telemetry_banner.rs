...
const TITLE_NEW_USERS: &str = "Help improve Rook.";
const DESCRIPTION: &str = "We may collect certain console interactions to improve Rook's AI capabilities. You can opt out any time.";
