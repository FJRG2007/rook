...
use rookui::elements::{Align, ChildView, Container, ParentElement, SavePosition, Stack};
use rookui::{
...
impl SuggestionChipView {
    pub fn new_rule_chip(rule: SuggestedRule, ctx: &mut ViewContext<Self>) -> Self {
        Self::listen_for_rook_drive_events(ctx);
    ...
    fn listen_for_rook_drive_events(ctx: &mut ViewContext<Self>) {
