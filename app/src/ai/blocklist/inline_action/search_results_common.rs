...
use rookui::{AppContext, EventContext, SingletonEntity};
...
pub fn render_search_results_header(
    ...
    is_expanded: bool,
    mouse_state: rookui::elements::MouseStateHandle,
    ...
    rookui::elements::Hoverable::new(mouse_state, |_| inner)
