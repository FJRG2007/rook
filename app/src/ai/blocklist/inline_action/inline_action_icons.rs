...
pub fn green_check_icon(appearance: &Appearance) -> rookui::elements::Icon {
...
pub fn red_x_icon(appearance: &Appearance) -> rookui::elements::Icon {
    rookui::elements::Icon::new(
        Icon::X.into(),
...
pub fn warning_icon(appearance: &Appearance) -> rookui::elements::Icon {
    rookui::elements::Icon::new(
        Icon::Triangle.into(),
...
pub fn cancelled_icon(appearance: &Appearance) -> rookui::elements::Icon {
    rookui::elements::Icon::new(
        Icon::Cancelled.into(),
...
pub fn reverted_icon(appearance: &Appearance) -> rookui::elements::Icon {
    rookui::elements::Icon::new(
