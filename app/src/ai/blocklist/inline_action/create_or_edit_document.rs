...
use rook_core::ui::icons::Icon as CoreIcon;
use rook_core::ui::theme::color::internal_colors::neutral_2;
use rookui::elements::{
...
impl CreateOrEditDocumentAction {
    ...
    pub fn render(self, app: &AppContext) -> Box<dyn Element> {
        ...
        let content = Container::new(row.finish())
            ...
            .with_border(rookui::elements::Border::all(1.).with_border_fill(theme.surface_2()))
            .finish();
