...
use rook_managed_secrets::client::{IdentityTokenOptions, ManagedSecretsClient, TaskIdentityToken};
...
const CLOUD_AGENT_OTLP_TOKEN: &str = "ROOK_CLOUD_AGENT_OTLP_TOKEN";
const CLOUD_AGENT_OTLP_TOKEN_EXPIRES_AT: &str = "ROOK_CLOUD_AGENT_OTLP_TOKEN_EXPIRES_AT";
const OZ_RUN_ID: &str = "OZ_RUN_ID";
/// The collector audience and requested lifetime are fixed by the cloud-agent trace contract.
const COLLECTOR_AUDIENCE: &str = "rook-cloud-agent-otel";
