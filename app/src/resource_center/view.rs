...
const DISCORD_SVG_PATH: &str = "bundled/svg/discord-logo.svg";
...
impl ResourceCenterFooterItem {
    pub fn ui_label(&self) -> &'static str {
        match self {
            ...
            ResourceCenterFooterItem::Discord => "Join our Discord community",
    ...
    pub fn svg_path(&self) -> &'static str {
        match self {
            ...
            ResourceCenterFooterItem::Discord => DISCORD_SVG_PATH,
...
impl ResourceCenterView {
    ...
    fn footer_item_click_action(
        ...
        match item {
            ...
            ResourceCenterFooterItem::Discord => ctx.open_url(links::DISCORD_URL),
    ...
    fn render_footer_button(
        ...
        let mouse_state = match item {
            ...
            ResourceCenterFooterItem::Discord => self.button_mouse_states.join_discord.clone(),
    ...
    fn render_footer(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let discord_button =
            self.render_footer_button(ResourceCenterFooterItem::Discord, appearance);
        let feedback_button =
            self.render_footer_button(ResourceCenterFooterItem::Feedback, appearance);

        let footer = Flex::row()
            .with_child(docs_button)
            .with_child(discord_button)
