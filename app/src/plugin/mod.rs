...
/// Flag to be passed to the rook executable when executing the rook binary as the plugin host
...
/// plugin host process.
const PLUGIN_HOST_ADDRESS_ENV_VAR: &str = "ROOK_PLUGIN_HOST_ADDRESS";
