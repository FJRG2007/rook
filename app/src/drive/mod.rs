...
pub struct OpenRookDriveObjectSettings {
    /// The folder that should be focused in the Rook Drive when the object is opened.
...
pub struct OpenRookDriveObjectArgs {
    pub object_type: ObjectType,
    pub server_id: ServerId,
    pub settings: OpenRookDriveObjectSettings,
}
...
/// Enum used for sorting elements in the Rook Drive Index (and potentially other places).
...
#[schemars(
    description = "Sort order for Rook Drive items.",
