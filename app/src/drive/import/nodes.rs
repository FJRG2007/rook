...
impl FolderNode {
    ...
    fn render(
        ...
        let icon_color =
            override_color.unwrap_or(rook_drive_icon_color(appearance, DriveObjectType::Folder));
        let icon = ConstrainedBox::new(
            Icon::Folder
                .to_rookui_icon(Fill::Solid(icon_color))
                .finish(),
        )
    ...
    fn render_status_icon(
        ...
        let status_icon_element = match &self {
            ...
            UploadStatus::Loaded(_) => Icon::Check
                .to_rookui_icon(Fill::Solid(ColorU::new(11, 142, 71, 255)))
                .finish(),
            UploadStatus::Error(_) => Icon::AlertTriangle
                .to_rookui_icon(Fill::Solid(appearance.theme().ui_error_color()))
                .finish(),
        };
    ...
    fn render(
        ...
        let icon_element = match &self.file_type {
            FileType::Workflow => Icon::Workflow
                .to_rookui_icon(Fill::Solid(override_color.unwrap_or(
