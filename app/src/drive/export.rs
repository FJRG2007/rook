...
use rookui::platform::{FilePickerConfiguration, OperatingSystem};
...
/// Singleton model for exporting from Rook Drive.
...
impl ExportManager {
    ...
    fn handle_failure(
        ...
        let id = *export.key();
        // Don't send the error to Sentry, since it likely includes a user file path and their Rook
