...
use rookui::elements::{ResizableStateHandle, resizable_state_handle};
use rookui::{Entity, SingletonEntity, WindowId};

use crate::app_state::WindowSnapshot;

pub const DEFAULT_UNIVERSAL_SEARCH_WIDTH: f32 = 700.;
pub const DEFAULT_ROOK_AI_WIDTH: f32 = 410.;
pub const DEFAULT_VOLTRON_WIDTH: f32 = 700.;
pub const DEFAULT_ROOK_DRIVE_INDEX_WIDTH: f32 = 300.;
...
pub struct ModalSizes {
    ...
    pub rook_ai_width: ResizableStateHandle,
    pub voltron_width: ResizableStateHandle,
    pub rook_drive_index_width: ResizableStateHandle,
...
impl ModalSizes {
    ...
    pub fn from_restored(
        ...
        let rook_ai_width = window_snapshot
            .rook_ai_width
            .unwrap_or(DEFAULT_ROOK_AI_WIDTH);
        let voltron_width = window_snapshot
            .voltron_width
            .unwrap_or(DEFAULT_VOLTRON_WIDTH);
        let rook_drive_index_width = window_snapshot
            .rook_drive_index_width
            .unwrap_or(DEFAULT_ROOK_DRIVE_INDEX_WIDTH);
        ...
        Self {
            ...
            rook_ai_width: resizable_state_handle(rook_ai_width),
            voltron_width: resizable_state_handle(voltron_width),
            rook_drive_index_width: resizable_state_handle(rook_drive_index_width),
    ...
    pub fn default_with_panel_defaults(left_default: f32, right_default: f32) -> Self {
        ModalSizes {
            ...
            rook_ai_width: resizable_state_handle(DEFAULT_ROOK_AI_WIDTH),
            voltron_width: resizable_state_handle(DEFAULT_VOLTRON_WIDTH),
            rook_drive_index_width: resizable_state_handle(DEFAULT_ROOK_DRIVE_INDEX_WIDTH),
    ...
    pub fn get_resizable_state_handle(&self, modal: ModalType) -> ResizableStateHandle {
        match modal {
            ...
            ModalType::RookAIWidth => self.rook_ai_width.clone(),
            ModalType::VoltronWidth => self.voltron_width.clone(),
            ModalType::RookDriveIndexWidth => self.rook_drive_index_width.clone(),
