...
pub async fn execute_command(
    ...
    // when Rook is launched via launchd (Finder, Dock) with a minimal environment.
...
#[cfg(feature = "local_tty")]
const PATH_CAPTURE_START: &str = "__ROOK_PATH_CAPTURE_START__";
#[cfg(feature = "local_tty")]
const PATH_CAPTURE_END: &str = "__ROOK_PATH_CAPTURE_END__";
...
async fn capture_interactive_shell_env(
    ...
    // controlling terminal with `tcsetpgrp` [1]. If the Rook process itself tries to read from
