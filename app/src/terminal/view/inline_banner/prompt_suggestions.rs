...
use crate::ui_components::icons::Icon as RookUIIcon;
...
/// Free-plan users who run out of Rook-provided AI credits should get a modal
        ...
        inner_banner_flex.add_child(
            Shrinkable::new(
                ...
                render_button(
                    ...
                    Rc::new(move |ctx: &mut rookui::EventContext<'_>| {
