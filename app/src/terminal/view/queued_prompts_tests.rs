...
use rookui::{App, SingletonEntity, TypedActionView, ViewContext, ViewHandle};
...
fn drain_one(
    model: &rookui::ModelHandle<QueuedQueryModel>,
    app: &mut App,
...
where
    F: FnOnce(App, rookui::ModelHandle<QueuedQueryModel>, AIConversationId) + 'static,
{
