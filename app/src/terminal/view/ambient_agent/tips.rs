...
pub fn get_cloud_mode_tips() -> Vec<CloudModeTip> {
    vec![
        ...
        CloudModeTip::new(
            ...
            Some("https://docs.rook.dev/platform/environments/"),
        ),
        CloudModeTip::new(
        ...
        CloudModeTip::new(
            ...
            Some("https://docs.rook.dev/platform/overview/"),
        ),
        CloudModeTip::new(
            "Fork a completed Oz cloud agent session into Rook to continue the work locally.",
            Some("https://docs.rook.dev/platform/viewing-cloud-agent-runs"),
        ),
        CloudModeTip::new(
            "Build internal tools that use agents to answer questions from your databases.",
            Some("https://docs.rook.dev/platform/integrations"),
        ),
        CloudModeTip::new(
        ...
        CloudModeTip::new(
            ...
            Some("https://docs.rook.dev/agents/capabilities/mcp"),
        ),
        CloudModeTip::new(
            "Use `oz agent run` to kick off tasks without opening the Rook terminal.",
            Some("https://docs.rook.dev/platform/overview/"),
        ),
        CloudModeTip::new(
        ...
        CloudModeTip::new(
            ...
            Some("https://docs.rook.dev/platform/triggers"),
        ),
        CloudModeTip::new(
