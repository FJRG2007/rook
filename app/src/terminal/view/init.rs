...
pub fn init(app: &mut AppContext) {
    ...
    // Register input mode bindings before rookify bindings so ctrl-i rookifies
    // instead of opening inline agent when a rookify banner is visible.
    ...
    app.register_fixed_bindings([
        ...
        FixedBinding::standard(
            rookui::actions::StandardAction::Paste,
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            "[Debug] Onboarding Callout: RookInput - Project",
        ...
        EditableBinding::new(
            ...
            "[Debug] Onboarding Callout: RookInput - No Project",
            TerminalAction::OnboardingFlow(OnboardingVersion::Agent(
    ...
    app.register_editable_bindings([EditableBinding::new(
        ...
        BindingDescription::new("Initiate project for rook"),
...
fn register_input_mode_bindings(app: &mut AppContext) {
    ...
    // Rook agent should not be tagged into a CLI agent's command, and the
