...
// under the Apache license; see: crates/rook_terminal/src/model/LICENSE-ALACRITTY.
...
use crate::terminal::model::ansi::{Color, NamedColor, color_index};
    ...
    pub(super) fn foreground_color(
        ...
        if self.is_filter_match() {
            ...
            *URL_COLOR
            ...
            rookui::color::ColorU::new(128, 128, 128, 255)
