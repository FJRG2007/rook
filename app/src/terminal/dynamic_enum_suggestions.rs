use rook_completer::completer::{CommandOutput, GeneratorContext};
...
fn parse_dynamic_command(output: &CommandOutput) -> anyhow::Result<Vec<String>> {
    match output.status {
        rook_completer::completer::CommandExitStatus::Success => {
        ...
        rook_completer::completer::CommandExitStatus::Failure => {
