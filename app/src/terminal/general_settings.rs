...
use rook_core::settings::{RespectUserSyncSetting, SupportedPlatforms, SyncToCloud};
...
define_settings_group!(GeneralSettings, settings: [
    show_warning_before_quitting: ShowWarningBeforeQuitting {
        ...
        description: "Whether to show a warning dialog before quitting Rook.",
    },
    quit_on_last_window_closed: QuitOnLastWindowClosed {
        ...
        description: "Whether to quit Rook when the last window is closed.",
    },
    restore_session: RestoreSession {
        ...
        description: "Whether to restore the previous session when Rook starts up.",
    },
    add_app_as_login_item: LoginItem {
        ...
        description: "Whether to launch Rook automatically when you log in.",
    },
    ...
    open_in_rook_banner_dismissed_for_markdown: OpenInRookBannerDismissedMarkdown {
        type: bool,
        default: false,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Never,
    ...
    open_in_rook_banner_dismissed_for_code_and_text: OpenInRookBannerDismissedCode {
        type: bool,
        default: false,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Never,
    ...
    // One-time flag tracking whether the OpenRook launch modal has already been
    ...
    did_check_to_trigger_openrook_launch_modal: DidShowOpenRookLaunchModal {
        type: bool,
        default: false,
        supported_platforms: SupportedPlatforms::ALL,
