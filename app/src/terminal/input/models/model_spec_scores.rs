...
use rookui::prelude::{Align, CrossAxisAlignment};
...
pub const MODEL_SPECS_DESCRIPTION: &str = "Rook's benchmarks for how well a model performs in our harness, the rate at which it consumes credits, and task speed.";
