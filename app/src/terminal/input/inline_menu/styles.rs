...
pub fn primary_text_color(theme: &RookTheme, background: Fill) -> Fill {
    theme.main_text_color(background)
}

pub fn secondary_text_color(theme: &RookTheme, background: Fill) -> Fill {
    theme.sub_text_color(background)
}

pub fn disabled_text_color(theme: &RookTheme, background: Fill) -> Fill {
