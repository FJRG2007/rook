    ...
    App::test((), |app| async move {
        app.read(|ctx| {
            ...
            let block_index = insert_block(
                &mut block_list,
                "echo https://rook.dev/about hello/world.js\n",
                "https://rook.dev/about hello/world.js\n",
            );
            ...
            assert_eq!(
                ...
                Some("https://rook.dev/about".to_string())
            );
            block_list.clear_selection();

            // Start a selection at the "p" in "rook", which has wrapped to the third
            // line of the command grid.
            block_list.start_selection(
            ...
            assert_eq!(
                block_list.selection_to_string(&semantic_selection, false, ctx),
                Some("https://rook.dev/about hello".to_string())
            );
            block_list.clear_selection();
...
fn test_smart_selection_in_multiple_blocks() {
    App::test((), |app| async move {
        app.read(|ctx| {
            ...
            assert_eq!(
                block_list.selection_to_string(&semantic_selection, false, ctx),
                Some("https://rook.dev/about hello/world.js\nhttps".to_string())
            );
            block_list.clear_selection();
...
fn test_smart_selection_override() {
    App::test((), |app| async move {
        app.read(|ctx| {
            ...
            let block_index = insert_block(
                &mut block_list,
                "echo https://rook.dev/about hello/world",
                "https://rook.dev/about hello/world",
            );

            // the override wraps "https://rook.dev/about hello/world"
            ...
            // Start a selection at the "w" in "rook"
            ...
            assert_eq!(
                block_list.selection_to_string(&semantic_selection, false, ctx),
                Some("https://rook.dev/about hello/world".to_string())
            );
        })
    })
}
