...
/// Whether this keystroke should dispatch an action in Rook despite the
/// [`rookui::event::Event::KeyDown::is_composing`] being true.
///
...
///
/// This function is intended to be used when handling [`rookui::event::Event::KeyDown`] when its
