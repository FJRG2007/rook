    ...
    fn create_menu(
            ...
            menu.add_item(
                MenuItemFields::new(block_type.label())
                    ...
                    .with_on_select_action(EditorViewAction::InsertBlock(
                        rook_editor::content::text::BlockType::Text(block_type.into()),
                    ))
                    .into_item(),
            );
        }
        ...
        menu.add_item(
            MenuItemFields::new("Divider")
                ...
                .with_on_select_action(EditorViewAction::InsertBlock(
                    rook_editor::content::text::BlockType::Item(BufferBlockItem::HorizontalRule),
                ))
...
impl RichTextEditorView {
    ...
    fn insert_embedded_workflow(&mut self, id: &SyncId, ctx: &mut ViewContext<Self>) {
        self.insert_block(
            rook_editor::content::text::BlockType::Item(BufferBlockItem::Embedded {
