 ...
 # Rook bootstrap script contents from showing up in the history.
 ...
 # 1. We remove the guard for duplicate inclusion since we have different logic in rook where we execute this function.
 ...
 #### In Rook's inclusion of bash-preexec, we don't include these two guards
 ...
 #### determine whether we want to execute bash-preexec or not.
     ...
     #    return 0
     #fi
 #### End of difference 1/4 between Rook and bash-preexec's original source.
 ...
 #### For Rook, the clause below prevents the typeahead readline binding from triggering
 ...
 #### End of difference 2/4 between Rook and bash-preexec's original source.
 ...
 # End of difference 3/4 between Rook and bash-preexec's original source.
 ...
 ### In Rook, we run this last install step in the install_bashpreexec
 ### function so this is commented out here.
     ## Run our install so long as we're not delaying it.
     #if [[ -z "${__bp_delay_install:-}" ]]; then
     #    __bp_install_after_session_init
     #fi;
 ### End of difference 4/4 between Rook and bash-preexec's original source.
 }
 ...
 # the rook bootstrap script. We take over startup from the shell so we have
 ...
 read -r -d '' ROOK_BOOTSTRAP_VAR << 'EOM'
...
EOM
 ...
 stty sane
 eval "$ROOK_BOOTSTRAP_VAR"; unset ROOK_BOOTSTRAP_VAR
