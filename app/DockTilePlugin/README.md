Implements a dock tile plugin for Rook.
...
The plugin is installed into the app bundle at `Contents/PlugIns/RookDockTilePlugin.docktileplugin` and is bundled using the script/mac/bundle script.  It is built as a universal binary for both arm64 and x86_64.
