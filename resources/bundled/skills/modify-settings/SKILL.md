...
description: View or modify Rook application settings using the bundled JSON schema for guidance
---

# modify-settings

Use this skill when the user wants to view, change, or troubleshoot Rook application settings.
...
If the file does not exist yet, create it. Rook hot-reloads this file, so changes take effect immediately.
