...
```json
{
  ...
  "prs": [
    {
      "number": 1234,
      "url": "https://github.com/FJRG2007/rook/pull/1234",
      "title": "...",
      "commit_subject": "... (#1234)",
      "author": "username",
      "body": "...",
      ...
      "linked_issues": [5678],
      "changed_files": ["app/src/ai/agent.rs", "crates/rook_features/src/lib.rs"],
      "source_repo": "FJRG2007/rook",
      "internal_pr": {
        "number": 25712,
        "url": "https://github.com/warpdotdev/warp-internal/pull/25712",
        "author": "rook-repo-sync[bot]",
        "title": "...",
...
python3 .agents/skills/changelog-draft/scripts/extract_feature_flags.py \
  --file crates/rook_features/src/lib.rs
```
  ...
  "issue_reporters": [
    {
      ...
      "url": "https://github.com/FJRG2007/rook/issues/5678"
    }
  ]
}
```
...
- Set `impacts_tui: true` when Rook Agent CLI users observe the change, including shared Agent capabilities such as tool-call or edit-file behavior
- When in doubt, set `needs_review: true` and `confidence: "low"`
- Bot PRs (dependabot, renovate, etc.) → `include: false`

**Feature-flag detection:** Use the `changed_files` list from Step 2 to check if any PR touches `crates/rook_features/src/lib.rs` or references a `FeatureFlag` variant in its title/body. Cross-reference with the flag lists from Step 4 to determine channel visibility.
...
## New Features
- Added dark mode ([#1234](https://github.com/FJRG2007/rook/pull/1234)) — [@external-contributor](https://github.com/external-contributor) ✨

## Improvements
- Faster tab switching ([#1235](https://github.com/FJRG2007/rook/pull/1235))

## Bug Fixes
- Fixed crash on startup ([#1236](https://github.com/FJRG2007/rook/pull/1236))

## TUI Updates
- Added inline command menus to Rook Agent CLI ([#1238](https://github.com/FJRG2007/rook/pull/1238))

## Oz Updates
- Improved agent memory ([#1237](https://github.com/FJRG2007/rook/pull/1237))

## Community
### Contributors
- [@contributor1](https://github.com/contributor1) — [#1234](https://github.com/FJRG2007/rook/pull/1234)  ✨

### Issue Reporters
Thanks to the community members who reported issues fixed in this release:
- [@reporter1](https://github.com/reporter1) — [#5678](https://github.com/FJRG2007/rook/issues/5678) "Crash when opening large file"
```
