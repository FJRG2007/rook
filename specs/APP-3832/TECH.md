...
- If more hover sidecars are added elsewhere in Rook, consider extracting a reusable “row + sidecar + safe triangle” helper instead of keeping the logic local to vertical tabs.
