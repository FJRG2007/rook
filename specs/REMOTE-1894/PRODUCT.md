...
- Server-side LLM/turn retries (landed separately in rook-server #11754/#11755/#11770).

## Behavior

"User" below means both the operator observing a cloud run (Oz UI, run state API, pipeline webhooks) and the Rook user watching a local agent conversation.
