...
Targeted checks:
- `cargo nextest run -p rook terminal::view::shared_session::view_impl_test terminal::view_test`
- `cargo nextest run -p rook pane_group::mod_tests ai::agent_conversations_model_tests`
