...
## Relevant code
- `crates/rook_features/src/lib.rs:757,826` — `FeatureFlag::AgentHarness`, `FeatureFlag::CloudModeSetupV2`.
...
- `rook_cli::agent::Harness` (`crates/rook_cli/src/agent.rs:120-131`) — `Oz`, `Claude`, `Gemini`.
## Current state
