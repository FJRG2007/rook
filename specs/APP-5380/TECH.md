...
## Context
The accepted behavior is defined in [PRODUCT.md](PRODUCT.md). At [`afd2aecd`](https://github.com/FJRG2007/rook/tree/afd2aecd461f73699318f0d87b576fda3c2a1511), [`crates/ai/src/api_keys.rs`](https://github.com/FJRG2007/rook/blob/afd2aecd461f73699318f0d87b576fda3c2a1511/crates/ai/src/api_keys.rs) stores provider credentials and complete `CustomEndpoint` values in the `AiApiKeys` secure blob. [`app/src/settings_view/rook_agent_page.rs`](https://github.com/FJRG2007/rook/blob/afd2aecd461f73699318f0d87b576fda3c2a1511/app/src/settings_view/rook_agent_page.rs) performs GUI endpoint CRUD by secure-blob vector index.

[`app/src/ai/llms.rs`](https://github.com/FJRG2007/rook/blob/afd2aecd461f73699318f0d87b576fda3c2a1511/app/src/ai/llms.rs) synthesizes selectable custom models from those secure values, and [`app/src/ai/agent/api.rs`](https://github.com/FJRG2007/rook/blob/afd2aecd461f73699318f0d87b576fda3c2a1511/app/src/ai/agent/api.rs) serializes them on agent requests. The TUI consumes the shared picker and controller but [`crates/rook_tui/src/api_keys_menu.rs`](https://github.com/FJRG2007/rook/blob/afd2aecd461f73699318f0d87b576fda3c2a1511/crates/rook_tui/src/api_keys_menu.rs) exposes credentials only for fixed providers.

The implementation follows the file-backed execution-profile precedent in [`app/src/ai/execution_profiles/config.rs`](https://github.com/FJRG2007/rook/blob/afd2aecd461f73699318f0d87b576fda3c2a1511/app/src/ai/execution_profiles/config.rs) and [`app/src/ai/execution_profiles/profiles.rs`](https://github.com/FJRG2007/rook/blob/afd2aecd461f73699318f0d87b576fda3c2a1511/app/src/ai/execution_profiles/profiles.rs): a validated stable-keyed settings collection, an explicit source/authority state, and one-time import that waits for settings reconciliation.
## Proposed changes
...
Run focused `cargo nextest` suites for `ai`, `rook`, and `rook_tui`; `./script/format`; targeted clippy for changed crates and targets; and a live `./script/run-tui` verification that unconfigured endpoints are omitted while needs-key, connected, and invalid-setting states update without a restart.
