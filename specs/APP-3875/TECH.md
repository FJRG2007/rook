...
This setting is only used when `vertical_tabs_display_granularity == Tabs`, but it should still be persisted independently so Rook can restore the user's last chosen Tabs-mode representation.
