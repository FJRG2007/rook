...
- Restart Rook and verify restored panes keep their custom names.
...
```bash
cargo test -p rook_app vertical_tabs
cargo test -p rook_app persistence::sqlite_tests
cargo test -p rook_app workspace::action_tests
```
