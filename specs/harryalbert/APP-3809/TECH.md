...
### Feature flags
- `crates/rook_features/src/lib.rs:9` — `FeatureFlag` enum.
- `crates/rook_features/src/lib.rs:797` — `DOGFOOD_FLAGS` array.
...
1. Existing user launches Rook with `HOAOnboardingFlow` enabled.
