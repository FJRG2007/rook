...
12. While auto-queue is active, the prompt-queue chip in the rooking indicator renders in its active (accent-colored) state, identical to when the user enables queue mode manually.
