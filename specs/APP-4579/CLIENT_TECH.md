...
Implements the client-side surface of `specs/APP-4579/PRODUCT.md`. Server persistence and hidden-prompt injection are specified in `../rook-server/specs/APP-4579/TECH.md`.
## Problem
