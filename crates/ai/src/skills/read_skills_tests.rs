...
fn test_parse_skills_dirs_env_empty_value_returns_empty() {
    // TODO: Audit that the environment access only happens in single-threaded code.
    unsafe { std::env::set_var("ROOK_SKILL_DIRS", "") };
    let dirs = super::parse_skills_dirs_env();
    assert!(dirs.is_empty());
    // TODO: Audit that the environment access only happens in single-threaded code.
    unsafe { std::env::remove_var("ROOK_SKILL_DIRS") };
...
fn test_parse_skills_dirs_env_single_path() {
    // TODO: Audit that the environment access only happens in single-threaded code.
    unsafe { std::env::set_var("ROOK_SKILL_DIRS", "/foo/bar/skills") };
    let dirs = super::parse_skills_dirs_env();
...
fn test_parse_skills_dirs_env_multiple_paths() {
    // TODO: Audit that the environment access only happens in single-threaded code.
    unsafe { std::env::set_var("ROOK_SKILL_DIRS", "/a/skills,/b/skills,/c/skills") };
    let dirs = super::parse_skills_dirs_env();
    assert_eq!(
        dirs,
        vec![
...
fn test_parse_skills_dirs_env_trims_whitespace_and_drops_blanks() {
    // TODO: Audit that the environment access only happens in single-threaded code.
    unsafe { std::env::set_var("ROOK_SKILL_DIRS", " /a/skills , , /b/skills ") };
    let dirs = super::parse_skills_dirs_env();
    assert_eq!(
        dirs,
        vec![
