...
/// Level of Rook hierarchy or orthogonal product noun an action targets.
...
macro_rules! define_action_catalog {
    ($(
        ...
        /// Stable protocol name for every approved `rookctrl` action.
...
define_action_catalog! {
    ...
    surface {
        ...
        SurfaceRookDriveOpen => { name: "surface.rook_drive.open", status: Implemented, target: Surface, params: None, result: Acknowledgement },
        SurfaceRookDriveToggle => { name: "surface.rook_drive.toggle", status: Implemented, target: Surface, params: None, result: Acknowledgement },
