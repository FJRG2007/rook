...
#[test]
fn test_split_path() {
    let path = TypedPathBuf::from_unix("/Users/rookuser");
    ...
    assert_eq!(
        split_path,
        SplitPath {
            directory_absolute_path: TypedPathBuf::from("/Users/rookuser/Rook.app/"),
            directory_relative_path_name: "Rook.app/".to_owned(),
    ...
    assert_eq!(
        split_path,
        SplitPath {
            directory_absolute_path: TypedPathBuf::from("/Users/rookuser/Rook.app/macOS/bin/"),
            directory_relative_path_name: "Rook.app/macOS/bin/".to_owned(),
            file_name: "rook.o".to_owned()
        }
    );
}
...
pub fn test_sorted_paths_relative_to() {
    ...
    assert_eq!(
        rookui_core::r#async::block_on(sorted_paths_relative_to(
            &ParsedToken::empty(),
...
pub fn test_sorted_directories_relative_to() {
    ...
    assert_eq!(
        rookui_core::r#async::block_on(sorted_directories_relative_to(
            &ParsedToken::empty(),
            MatchStrategy::CaseInsensitive,
            &ctx
        ))
...
pub fn test_sorted_paths_case_insensitive_ordering() {
    ...
    let suggestions: Vec<String> = rookui_core::r#async::block_on(sorted_paths_relative_to(
        &ParsedToken::empty(),
        MatchStrategy::CaseInsensitive,
        &ctx,
    ))
...
pub fn test_sorted_cd_directories_no_cdpath_matches_existing_behavior() {
    ...
    let from_cd = rookui_core::r#async::block_on(sorted_cd_directories(
        &ParsedToken::empty(),
        MatchStrategy::CaseInsensitive,
        &ctx,
    ));
    let from_default = rookui_core::r#async::block_on(sorted_directories_relative_to(
        &ParsedToken::empty(),
        MatchStrategy::CaseInsensitive,
        &ctx,
    ));
...
pub fn test_sorted_cd_directories_includes_cdpath_entries() {
    ...
    let displays: Vec<String> = rookui_core::r#async::block_on(sorted_cd_directories(
        &ParsedToken::empty(),
        MatchStrategy::CaseInsensitive,
        &ctx,
    ))
