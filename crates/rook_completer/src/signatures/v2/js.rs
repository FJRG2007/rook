//! Contains `FromRookJs` trait implementations for converting JavaScript command signatures to
//! `rook_completer::signatures::CommandSignature`s, as well as `IntoRookJs` implementations for
...
use rook_js::{FromRookJs, IntoRookJs, JsFunctionRegistry};
...
impl<'js> FromRookJs<'js> for CommandSignature {
    fn from_rook_js(
        ctx: rquickjs::Ctx<'js>,
        ...
        let command = Command::from_rook_js(ctx, object.get("command")?, js_function_registry)?;
        Ok(Self { command })
    }
}

impl<'js> FromRookJs<'js> for Command {
    fn from_rook_js(
        ctx: rquickjs::Ctx<'js>,
        value: rquickjs::Value<'js>,
        js_function_registry: &mut JsFunctionRegistry,
...
impl<'js> FromRookJs<'js> for Argument {
    fn from_rook_js(
        ctx: rquickjs::Ctx<'js>,
        value: rquickjs::Value<'js>,
        js_function_registry: &mut JsFunctionRegistry,
...
impl<'js> FromRookJs<'js> for ArgumentValue {
    fn from_rook_js(
        ctx: rquickjs::Ctx<'js>,
        value: rquickjs::Value<'js>,
        js_function_registry: &mut JsFunctionRegistry,
        ...
        if value.is_object() {
            ...
            if object.contains_key("value")? {
                Ok(ArgumentValue::Suggestion(Suggestion::from_rook_js(
                    ctx,
                    object.into_value(),
...
impl<'js> FromRookJs<'js> for Suggestion {
    fn from_rook_js(
        ctx: rquickjs::Ctx<'js>,
        value: rquickjs::Value<'js>,
        js_function_registry: &mut JsFunctionRegistry,
...
impl<'js> FromRookJs<'js> for TemplateType {
    fn from_rook_js(
        ctx: rquickjs::Ctx<'js>,
        value: rquickjs::Value<'js>,
        js_function_registry: &mut JsFunctionRegistry,
    ) -> rquickjs::Result<Self> {
        let type_string = String::from_rook_js(ctx, value, js_function_registry)?;
...
impl<'js> FromRookJs<'js> for GeneratorFn {
    fn from_rook_js(
        ctx: rquickjs::Ctx<'js>,
        value: rquickjs::Value<'js>,
        js_function_registry: &mut JsFunctionRegistry,
        ...
        if value.is_object() {
            ...
            let script = GeneratorScript::from_rook_js(ctx, value, js_function_registry)?;
...
impl<'js> FromRookJs<'js> for GeneratorScript {
    fn from_rook_js(
        ctx: rquickjs::Ctx<'js>,
        value: rquickjs::Value<'js>,
        js_function_registry: &mut JsFunctionRegistry,
...
impl<'js> FromRookJs<'js> for GeneratorResults {
    fn from_rook_js(
        ctx: rquickjs::Ctx<'js>,
        value: rquickjs::Value<'js>,
        js_function_registry: &mut JsFunctionRegistry,
...
impl<'js> IntoRookJs<'js> for GeneratorCompletionContext {
    fn into_rook_js(self, ctx: rquickjs::Ctx<'js>) -> rquickjs::Result<Value<'js>> {
