...
/// The main Rook process spawns this via the `ripgrep-search` CLI
...
mod process_impl {
    ...
    /// Spawns the rook CLI with the `ripgrep-search` subcommand.
    fn spawn_search_process(
        ...
        cmd.arg(rook_cli::ripgrep_search_subcommand())
