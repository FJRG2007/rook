...
//!
//! **Note**: The full editor-backed `TuiInputView` lives in `crates/rook_tui/src/input/`
//! and is exercised by the real `rook-tui` binary (`./script/run-tui`). This
//! example proves out the TUI runtime layer independently of the editor.
//!
//! Run from a real terminal:
//!
//! ```sh
//! cargo run -p rookui_core --example tui_file_viewer --features tui -- /path/to/file.md
//! ```
//!
//! Keys:
...
use rookui_core::runtime::TuiRuntime;
use rookui_core::{
