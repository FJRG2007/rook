...
///
/// Checks the `ROOK_INTEGRATION_TEST_VIDEO` environment variable:
...
/// ```sh
/// # Record all tests
/// ROOK_INTEGRATION_TEST_VIDEO=1 cargo nextest run ...
///
/// # Record only specific tests
/// ROOK_INTEGRATION_TEST_VIDEO=test_foo,test_bar cargo nextest run ...
/// ```
