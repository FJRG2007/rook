    ...
    fn get(&self, path: &str) -> Result<Cow<'_, [u8]>> {
        match path {
            ...
            "fit-test.rgba" => Ok(Cow::Borrowed(
                b"rook-img:rgba:4:2:\xff\x00\x00\xff\xff\x00\x00\xff\x00\x00\xff\xff\x00\x00\xff\xff\x00\xff\x00\xff\x00\xff\x00\xff\xff\xff\xff\xff\xff\xff\xff\xff",
            )),
            "numbers-1000ms.gif" => Ok(Cow::Borrowed(include_bytes!(
                "../../rookui/examples/assets/numbers-1000ms.gif"
            ))),
...
fn test_svg_text_rasterizes_with_loaded_system_fonts() {
  ...
  <text x="10" y="24" font-size="20" fill="#000000">Rook</text>
</svg>
"##,
    )
  ...
  <text x=\"10\" y=\"24\" font-family=\"{font_family}\" font-size=\"20\" fill=\"#000000\">Rook</text>\
</svg>"
    );
...
fn test_svg_text_rasterizes_with_bundled_sans_serif_fallback() {
    let image_type = ImageType::try_from_bytes(
        br##"<svg width="160" height="40" viewBox="0 0 160 40" xmlns="http://www.w3.org/2000/svg">
  <text x="10" y="24" font-family="sans-serif" font-size="20" fill="#000000">Rook</text>
</svg>
"##,
    )
    .expect("SVG should parse");
