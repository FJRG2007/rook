...
pub enum Event {
    ...
    MouseMoved {
        ...
        cmd: bool,
        shift: bool,
        /// Whether this mouse event was initiated by the user or by Rook synthetically.
        /// We create such synthetic mouse events for certain behaviors behaviors within
        /// Rook, such as triggering the correct tab to be "hovered" when the user closes
        ...
        /// the old tab (closed) to the new tab (shifted). Certain elements within Rook,
    ...
    /// Gets fired when user drags a file or folder into Rook. Note that there could exist
