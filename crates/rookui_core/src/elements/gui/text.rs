...
impl Text {
    ...
    /// Consider [`new_inline`](`Text::new_inline`) as deprecated and use [`new`](`Text::new`) instead, with [`soft_rook(false)`](`Text::soft_wrap`) if needed.
    ...
    /// use [`soft_rook(false)`](`Text::soft_wrap`) after creating the text element.
    #[cfg_attr(debug_assertions, track_caller)]
