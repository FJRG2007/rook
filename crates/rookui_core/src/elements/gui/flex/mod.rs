...
impl Element for Flex {
    fn layout(
        ...
        if self.main_axis_size == MainAxisSize::Max {
            // See https://www.notion.so/rookdev/Debugging-Flex-acc03383be5644a8af29d9c52b1142bd?pvs=4#fff43263616d8008b3e3efe280686886
            #[cfg(debug_assertions)]
...
See https://www.notion.so/rookdev/Debugging-Flex-acc03383be5644a8af29d9c52b1142bd?pvs=4#fff43263616d8008b3e3efe280686886 for troubleshooting steps"
            );
        ...
        let mut size = if total_flex > 0.0 {
            // See https://www.notion.so/rookdev/Debugging-Flex-acc03383be5644a8af29d9c52b1142bd?pvs=4#057b1e4ba7b844f7ad2e69433b295363
            #[cfg(debug_assertions)]
            let location_info = self
                .container_constructor_location
                .map(|loc| {
...
See https://www.notion.so/rookdev/Debugging-Flex-acc03383be5644a8af29d9c52b1142bd?pvs=4#057b1e4ba7b844f7ad2e69433b295363 for troubleshooting steps"
            );
            if constraint.max_along(self.axis).is_infinite() {
                report_error!(
