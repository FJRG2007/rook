...
lazy_static! {
    ...
    /// 22.1.2, in practice, Rook windows don't render properly until 24.0.2.
...
/// Returns whether or not the provided adapter is an unsupported Nvidia driver version for rookui
/// to render properly.
...
/// rookui to render properly. Affected adapters include:
...
/// See also https://github.com/FJRG2007/rook/issues/4856
...
/// alignment.
///
/// See: https://github.com/FJRG2007/rook/issues/6120
pub fn adapter_has_rendering_offset_bug(adapter_info: &wgpu::AdapterInfo) -> bool {
    ...
    // https://github.com/FJRG2007/rook/issues/6120.
    let affected_models = [
...
/// https://github.com/FJRG2007/rook/issues/10618
/// https://github.com/FJRG2007/rook/issues/4879
...
/// (Vulkan llvmpipe) adapter that may not work properly with rookui.
...
fn adapter_stability_sort_func(
    ...
    // Same with Nvidia drivers, though this is only an issue with a Wayland window server.
        ...
        log::warn!(
            ...
            https://docs.rook.dev/help/known-issues#linux-1",
...
enum AdapterSupport {
    ...
    /// The adapter is basically not viable. Rookui will either crash or not render.
    Unsupported = 2,
}
