...
use rookui_core::assets::AssetProvider;
use rookui_core::integration::TestDriver;
use rookui_core::keymap::{Keystroke, Trigger};
use rookui_core::modals::{AlertDialog, ModalId};
use rookui_core::platform::app::{
    AppCallbackDispatcher, ApproveTerminateResult, TerminationRequestSource,
};
use rookui_core::platform::menu::{Menu, MenuBar};
use rookui_core::platform::{self, FilePickerCallback, SaveFilePickerCallback};
use rookui_core::{AppContext, Event};
...
unsafe extern "C" {
    // Implemented in ObjC to get the rook NSApplication subclass.
    pub(super) fn get_rook_app() -> id;
}
...
impl App {
    ...
    pub(in crate::platform) fn run(
        ...
        autoreleasepool(|_| {
            ...
            // SAFETY: `get_rook_app()` returns the rook NSApplication subclass instance.
            let app_ptr = unsafe { get_rook_app() };
            ...
            unsafe {
                let app_delegate = app.delegate().expect("the rook app always has a delegate");
...
#[unsafe(no_mangle)]
pub(crate) extern "C-unwind" fn rook_app_send_global_keybinding(
    this: &mut Object,
...
#[unsafe(no_mangle)]
pub unsafe extern "C-unwind" fn rook_app_will_finish_launching(this: &mut Object) {
    unsafe {
        ...
        let app_delegate = ns_app
            .delegate()
            .expect("the rook app always has a delegate");

        if app.callbacks.has_internet_reachability_changed_callback() {
            // `setReachabilityListener` is a custom rook app-delegate selector.
        ...
        if let Some(dock_menu_builder) = app.dock_menu_builder.take() {
            ...
            // `setDockMenu:` is a custom rook app-delegate selector.
        ...
        // `setDockIconVisible:` is a custom rook app-delegate selector.
        let _: BOOL = msg_send![&*app_delegate, setDockIconVisible: show_dock_icon];
    }
}

#[unsafe(no_mangle)]
pub(crate) extern "C-unwind" fn rook_app_did_become_active(this: &mut Object, _: Sel, _: id) {
    let app = unsafe { get_app(this) };
    app.callbacks.app_became_active();
}

#[unsafe(no_mangle)]
pub(crate) extern "C-unwind" fn rook_app_internet_reachability_changed(
    this: &mut Object,
    can_reach: u8,
) {
...
#[unsafe(no_mangle)]
pub(crate) extern "C-unwind" fn rook_app_should_terminate_app(
    this: &mut Object,
...
#[unsafe(no_mangle)]
pub(crate) extern "C-unwind" fn rook_app_should_close_window(
    this: &mut Object,
...
#[unsafe(no_mangle)]
pub(crate) extern "C-unwind" fn rook_app_are_key_bindings_disabled_for_window(
    this: &mut Object,
    window_id: &mut Object,
) -> BOOL {
    let app = unsafe { get_app(this) };
...
#[unsafe(no_mangle)]
pub(crate) extern "C-unwind" fn rook_app_has_binding_for_keystroke(
    this: &mut Object,
    event: id,
) -> BOOL {
    let app = unsafe { get_app(this) };
    let rook_event = unsafe { super::event::from_native(event, None, false) };

    let Some(Event::KeyDown { keystroke, .. }) = rook_event else {
        return NO;
    };
...
#[unsafe(no_mangle)]
pub(crate) extern "C-unwind" fn rook_app_has_custom_action_for_keystroke(
    this: &mut Object,
    event: id,
) -> BOOL {
    let app = unsafe { get_app(this) };
...
#[unsafe(no_mangle)]
pub(crate) extern "C-unwind" fn rook_app_disable_warning_modal(this: &mut Object) {
    let app = unsafe { get_app(this) };
    app.callbacks.warning_modal_disabled();
}

#[unsafe(no_mangle)]
pub(crate) extern "C-unwind" fn rook_app_process_modal_response(
    this: &mut Object,
    modal_id: ModalId,
    response: usize,
    disable_modal: bool,
...
#[unsafe(no_mangle)]
pub(crate) extern "C-unwind" fn rook_app_notification_clicked(
    this: &mut Object,
    date: f64,
    data: id,
) {
...
#[unsafe(no_mangle)]
extern "C-unwind" fn rook_app_did_resign_active(this: &mut Object, _: Sel, _: id) {
    let app = unsafe { get_app(this) };
    app.callbacks.app_resigned_active();
}

#[unsafe(no_mangle)]
extern "C-unwind" fn rook_app_will_terminate(this: &mut Object, _: Sel, _: id) {
    let app = unsafe { get_app(this) };
    app.callbacks.app_will_terminate();
}

#[unsafe(no_mangle)]
extern "C-unwind" fn rook_app_new_window(this: &mut Object) {
    let app = unsafe { get_app(this) };
    app.callbacks.open_new_window();
}

#[unsafe(no_mangle)]
extern "C-unwind" fn rook_app_active_window_changed(this: &mut Object) {
    let app = unsafe { get_app(this) };
...
#[unsafe(no_mangle)]
extern "C-unwind" fn rook_app_window_did_resize(this: &mut Object) {
    let app = unsafe { get_app(this) };
    app.callbacks.window_resized();
}

#[unsafe(no_mangle)]
extern "C-unwind" fn rook_app_window_did_move(this: &mut Object) {
    let app = unsafe { get_app(this) };
    app.callbacks.window_moved();
}

#[unsafe(no_mangle)]
extern "C-unwind" fn rook_app_window_will_close(this: &mut Object, window: &mut Object) {
    let app = unsafe { get_app(this) };
...
#[unsafe(no_mangle)]
extern "C-unwind" fn rook_app_screen_did_change(this: &mut Object) {
...
#[unsafe(no_mangle)]
extern "C-unwind" fn rook_app_open_files(this: &mut Object, paths: id) {
...
#[unsafe(no_mangle)]
extern "C-unwind" fn rook_app_open_urls(this: &mut Object, urls: id) {
...
#[unsafe(no_mangle)]
extern "C-unwind" fn rook_app_os_appearance_changed(this: &mut Object) {
    let app = unsafe { get_app(this) };
...
#[unsafe(no_mangle)]
pub(crate) extern "C-unwind" fn rook_open_panel_file_selected(urls: id, callback: *mut c_void) {
    ...
    // SAFETY: `get_rook_app()` returns the rook NSApplication subclass instance.
    let app = unsafe { get_app(&mut *get_rook_app()) };
...
#[unsafe(no_mangle)]
pub(crate) extern "C-unwind" fn rook_save_panel_file_selected(url: id, callback: *mut c_void) {
