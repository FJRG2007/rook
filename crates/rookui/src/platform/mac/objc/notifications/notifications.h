...
void rook_on_request_notification_permissions_completed(NSUInteger outcome_type, id outcome_msg,
                                                        void* callback);
...
void rook_on_notification_send_error(NSUInteger error_type, id error_msg, void* callback);
