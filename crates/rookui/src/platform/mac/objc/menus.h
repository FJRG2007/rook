...
// RookCustomMenuItemHandler is set as both the target and represented object of NSMenuItem.
// It gives the Rust side a chance to dynamically update menu items, and
// respond to their actions.
@interface RookCustomMenuItemHandler : NSObject <NSMenuItemValidation> {
    void *rustContext;
}
