//! Memory-behavior repros for APP-4154 batch 1.C (rookui-platform-nsstring).
//!
...
use rookui_core::platform::menu::{MenuItem, MenuItemPropertyChanges};
    ...
    unsafe {
        ...
        for _ in 0..APPLY_CHANGES_ITERS {
            let changes = MenuItemPropertyChanges {
                name: Some("Rook Menu Item".to_string()),
