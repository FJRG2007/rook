//! This crate defines the low-level, model-agnostic cloud object substrate shared by Rook crates.
//!
//! It owns server-facing identifiers, user identifiers, object metadata, object type and format
//! definitions, and sharing or drive primitives that do not depend on concrete Rook object models.
//!
