...
use rookui::{AddWindowOptions, EntityId, EntityIdMap, ViewHandle};
...
use rookui_core::{App, AppContext, TuiView, TypedActionView, ViewContext};
...
fn zero_height_agent_block_contributes_no_rows_and_grows_with_content() {
    App::test((), |mut app| async move {
        ...
        assert_eq!(
            source.take_selection_row_resizes(),
            vec![rookui_core::elements::tui::TuiRowResize {
                old_rows: 0..0,
