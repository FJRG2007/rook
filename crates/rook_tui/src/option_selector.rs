...
use rook::tui_export::{OptionBadge, OptionFooter, OptionRow, OptionSnapshot, OptionSourceStatus};
use rook_search_core::inline_menu::InlineMenuSelection;
...
use rookui_core::keymap::EditableBinding;
...
/// The selector zone that currently owns real RookUI focus.
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
impl TuiView for TuiOptionSelector {
    ...
    fn keymap_context(&self, app: &AppContext) -> rookui_core::keymap::Context {
