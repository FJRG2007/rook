...
use rookui::{AddWindowOptions, App, EntityId, EntityIdMap, SingletonEntity, TuiView};
...
use rookui_core::{AppContext, ViewContext, WindowInvalidation};
...
fn assert_drag_highlights_text(
    app: &App,
    transcript: &rookui::ViewHandle<TuiTranscriptView>,
