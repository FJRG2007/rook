//! Small presentation helpers for the `rook-tui` front-end's TUI views.
use std::sync::Arc;
...
pub(crate) fn append_welcome_capability_section(
    ...
    column = column.child(
        TuiText::new("What’s different about Rook")
