...
use rookui::App;
use rookui_core::elements::tui::Modifier;
...
fn shell_command_label_preserves_a_long_path_without_an_ellipsis() {
    let command = "ls -la /Users/moirahuang/.rook-dev/worktrees/rook/moira/pr-14381-combined/crates/rook_tui/src/tui_shell_command_view.rs";
