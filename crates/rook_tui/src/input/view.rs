...
use rook::tui_export::UserWorkspaces;
use rook::tui_export::{
...
use rookui_core::elements::tui::{TuiContainer, TuiElement, TuiFlex, TuiHoverable, TuiText};
#[cfg(feature = "voice_input")]
use rookui_core::event::KeyState;
use rookui_core::keymap::macros::*;
use rookui_core::keymap::{self, EditableBinding, FixedBinding, Keystroke};
#[cfg(feature = "voice_input")]
use rookui_core::platform::keyboard::KeyCode;
use rookui_core::text::{byte_offset_for_char_offset, count_chars_up_to_byte};
use rookui_core::{
...
pub enum TuiInputViewEvent {
    ...
    AcceptedConversation(rook::tui_export::AgentConversationEntryId),
    /// The user selected a model menu item.
    AcceptedModel(LLMId),
    AcceptedTeam(rook::tui_export::ServerId),
