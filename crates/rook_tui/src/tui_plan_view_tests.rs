...
use rookui::{AddWindowOptions, TypedActionView};
use rookui_core::elements::tui::{Color, Modifier, TuiBufferExt, TuiRect};
use rookui_core::presenter::tui::TuiPresenter;
use rookui_core::{App, TuiView, ViewHandle};
...
fn test_plan_view(
    ...
    rookui_core::ModelHandle<rook::tui_export::BlocklistAIActionModel>,
) {
...
) -> (Vec<String>, rookui_core::elements::tui::TuiBuffer) {
