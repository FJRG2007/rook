...
//! Rook title and version, either first-run guidance or a "What's new"
...
use rook::settings::{TuiZeroStateSettings, TuiZeroStateSettingsChangedEvent};
use rook::tui_export::{
...
use crate::zero_state_animation::{
    RookLogoStyles, ZeroStateAnimationConfig, ZeroStateAnimationConfigEvent,
...
fn build_zero_state_stack_layout(
    ...
    use rookui_core::elements::tui::TuiStack;
...
fn mcp_status_label(snapshot: &rook::tui_export::TuiMcpSnapshot) -> (String, bool) {
