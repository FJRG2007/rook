...
use rookui_core::{AppContext, Entity, ModelContext, ModelHandle, SingletonEntity, WindowId};
...
impl TuiConversationMenuModel {
    ...
    pub(crate) fn open(&mut self, ctx: &mut ModelContext<Self>) {
        ...
        rook::send_telemetry_from_ctx!(TuiConversationMenuTelemetryEvent::Opened, ctx);
