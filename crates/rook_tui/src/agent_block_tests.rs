...
use rookui_core::{App, AppContext, EntityId, EntityIdMap, TuiView, ViewContext, ViewHandle};
        ...
        app.read(|ctx| {
            ...
            assert_eq!(
                frame
                    ...
                    .collect::<Vec<_>>(),
                vec![
                    "You need AI credits in order to use Rook’s agent.".to_owned(),
    ...
    App::test((), |mut app| async move {
        ...
        app.read(|ctx| {
            ...
            assert!(
                lines
                    .iter()
                    .any(|line| line == "You need AI credits in order to use Rook’s agent.")
            );
            assert!(
                lines
                    .iter()
...
fn out_of_credits_failure_matches_tui_design_and_opens_upgrade() {
    App::test((), |mut app| async move {
        ...
        app.read(|ctx| {
            let presentation = FailedOutputPresentation::OutOfCredits {
                message: "I'm sorry, I couldn't complete that request.\n\nIn order to use Rook's AI features, subscribe to a Rook plan, or bring your own inference."
                    .to_owned(),
            ...
            assert_eq!(
                ...
                vec![
                    ...
                    "  In order to use Rook’s AI features, subscribe to a Rook plan or buy packs of credits."
                        .to_owned(),
                    String::new(),
