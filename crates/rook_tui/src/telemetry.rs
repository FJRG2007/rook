...
impl TelemetryEvent for TuiStartupTelemetryEvent {
    ...
    fn description(&self) -> &'static str {
        "The headless Rook TUI is launched"
    }
...
rook_core::register_telemetry_event!(TuiStartupTelemetryEvent);
...
impl TelemetryEventDesc for TuiConversationMenuTelemetryEventDiscriminants {
    ...
    fn description(&self) -> &'static str {
        match self {
            Self::Opened => "The conversation menu opened in the headless Rook TUI",
            Self::ItemSelected => "A conversation-menu item was selected in the headless Rook TUI",
        }
    }
...
rook_core::register_telemetry_event!(TuiConversationMenuTelemetryEvent);
...
impl TelemetryEvent for TuiConversationRestoreTelemetryEvent {
    ...
    fn description(&self) -> &'static str {
        "A conversation-list restore changed lifecycle state in the headless Rook TUI"
    }
...
rook_core::register_telemetry_event!(TuiConversationRestoreTelemetryEvent);
...
impl TelemetryEventDesc for TuiAutoupdateTelemetryEventDiscriminants {
    ...
    fn description(&self) -> &'static str {
        match self {
            TuiAutoupdateTelemetryEventDiscriminants::CheckCompleted => {
                "A rook-tui background update check completed with a new outcome"
            }
            TuiAutoupdateTelemetryEventDiscriminants::CheckFailed => {
                "A rook-tui background update check failed"
            }
        }
    }
...
rook_core::register_telemetry_event!(TuiAutoupdateTelemetryEvent);
