...
//!
//! The built-in Rook mark or a user-provided ASCII silhouette is sampled into a
...
/// Approximate visible bounds of the bundled Rook logo SVG.
const SVG_MIN_X: f64 = 35.0;
const SVG_MAX_X: f64 = 216.155;
const SVG_MIN_Y: f64 = 25.5701;
const SVG_MAX_Y: f64 = 170.489;

/// The upper-right and lower-left faces from `rook-logo-light.svg`.
///
...
#[derive(Clone, Copy)]
pub(crate) struct RookLogoStyles {
...
impl ObjectBounds {
    fn contains(self, point: rookui_core::elements::tui::TuiLocalPoint) -> bool {
...
fn rook_logo_contains(x: f64, y: f64) -> bool {
