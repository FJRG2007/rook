//! Repository metadata utilities for Rook.
//!
...
#[cfg(not(target_family = "wasm"))]
pub fn is_in_repo(path: &str, app: &rookui_core::AppContext) -> bool {
...
pub fn is_in_repo(_path: &str, _app: &rookui_core::AppContext) -> bool {
    false
}
