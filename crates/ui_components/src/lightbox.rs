...
impl button::Theme for ButtonTheme {
    fn background(
        ...
        match button_state {
            ...
            button::State::Hovered => Some(rook_core::ui::theme::Fill::white().with_opacity(10)),
            button::State::Pressed => Some(rook_core::ui::theme::Fill::white().with_opacity(15)),
        }
    }

    fn text_color(
        &self,
        _background: Option<rook_core::ui::theme::Fill>,
        _appearance: &Appearance,
    ) -> ColorU {
