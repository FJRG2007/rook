...
/// Events emitted from Rook on Web to the host JavaScript app.
///
/// These must stay in sync with the [`RookEvent` TypeScript type](https://github.com/warpdotdev/warp-server/blob/develop/client/src/rook-client/index.ts).
