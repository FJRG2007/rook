#!/usr/bin/env bash
# Installs the Rook remote server binary on a remote host, plus the
...
#   {download_base_url}         — e.g. https://app.rook.dev/download/cli
#   {channel}                   — stable | preview | dev
#   {install_dir}               — e.g. ~/.rook/remote-server
