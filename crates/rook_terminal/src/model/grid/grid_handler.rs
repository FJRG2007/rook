...
use rook_core::semantic_selection::{SMART_SELECT_MATCH_WINDOW_LIMIT, SemanticSelection};
use rook_core::{safe_assert, safe_assert_eq};
...
/// grid that needs to be kept in sync with Rook's grids. We do this via clearing the ConPTY
/// grid before Rook starts populating a new grid.
///
