//! Logic relating to a secondary process which Rook uses to spawn new shell
//! sessions.
//!
...
//! early during Rook's initialization, we can be more confident that there are
...
pub fn run_terminal_server(
    args: &rook_cli::TerminalServerArgs,
...
/// between processes, enabling the Rook application process to communicate
    ...
    pub fn new() -> Result<Self> {
        ...
        unsafe {
            ...
            let server = Command::new(program)
                ...
                .arg(rook_cli::terminal_server_subcommand())
