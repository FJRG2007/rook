...
/// Icon enum to be used within the app in place of the rookui_core::elements::Icon directly. It
...
pub enum Icon {
    ...
    NLD,
    Oz,
    /// The Rook "W" glyph used as the agent brand mark (sourced from
    /// `bundled/svg/rook-drive.svg`). The background and tint color are
    ...
    /// `Rook` so agent surfaces and non-agent Rook UI (e.g.
...
impl From<Icon> for &'static str {
    fn from(icon: Icon) -> &'static str {
        match icon {
            ...
            Icon::RookDrive => "bundled/svg/rook.svg",
            Icon::Rook => "bundled/svg/rook-drive.svg",
            Icon::RookLogoLight => "bundled/svg/rook-logo-light.svg",
            ...
            Icon::Rooking0 => "bundled/svg/rook-loading-0.svg",
            Icon::Rooking1 => "bundled/svg/rook-loading-1.svg",
            Icon::Rooking2 => "bundled/svg/rook-loading-2.svg",
            Icon::Rooking3 => "bundled/svg/rook-loading-3.svg",
            Icon::Rooking4 => "bundled/svg/rook-loading-4.svg",
            Icon::Rooking5 => "bundled/svg/rook-loading-5.svg",
            Icon::Rooking6 => "bundled/svg/rook-loading-6.svg",
            Icon::Rooking7 => "bundled/svg/rook-loading-7.svg",
            Icon::Rooking8 => "bundled/svg/rook-loading-8.svg",
            Icon::Rooking9 => "bundled/svg/rook-loading-9.svg",
            Icon::Rooking10 => "bundled/svg/rook-loading-10.svg",
            Icon::Rooking11 => "bundled/svg/rook-loading-11.svg",
            ...
            Icon::Oz => "bundled/svg/rook-3.svg",
            Icon::Agent => "bundled/svg/rook-drive.svg",
...
impl Icon {
    pub fn to_rookui_icon(self, color: Fill) -> RookUiIcon {
        RookUiIcon::new(self.into(), color.into_solid())
    }

    pub fn icon_for_key(key: &str) -> Option<RookUiIcon> {
        match key {
            "⏎" => Some(Self::CornerDownLeft.to_rookui_icon(Fill::black())),
            _ => None,
        }
    }
}
