...
integration_tests! {
    ...
    test_auto_title,
    // Tests zsh-specific behavior.
    test_rook_auto_title_disabled,
    // Tests bash-specific behavior.
    test_rook_honors_user_title_bash,
    // Tests zsh-specific behavior.
    test_rook_honors_user_title_zsh,
    ...
    // Tests zsh-specific right-prompt behavior in Rook prompt mode.
    test_rook_prompt_unsets_zsh_rprompt,
