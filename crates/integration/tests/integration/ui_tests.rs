...
integration_tests! {
    ...
    test_launch_rook_with_theme_in_rook_config,
    #[cfg(target_os="macos")]
    test_preview_config_dir_migration,
    #[ignore = "Flakes in CI"]
    test_add_launch_config_to_rook_config,
    #[ignore = "Flakes in CI"]
    test_add_workflows_to_rook_config,
    #[ignore = "Flakes in CI"]
    test_add_theme_to_rook_config,
    ...
    // run. Ignore for now.
    #[ignore]
    test_ask_rook_ai_keybinding_for_selected_block,
    ...
    test_file_tree_opens_files_in_rook,
