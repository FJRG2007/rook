...
) -> impl FnMut(&mut rookui_core::App, rookui_core::WindowId) -> rookui_core::integration::AssertionOutcome
{
    move |app, window_id| {
        let terminal_view = single_terminal_view_for_tab(app, window_id, 0);
        terminal_view.read(app, |view, _ctx| {
