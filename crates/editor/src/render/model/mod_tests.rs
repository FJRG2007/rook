...
// 18:09:15 [INFO] [rook_editor::render::model] Initial tree:
// -------- 0.00px / 0 characters --------
...
// 18:09:14 [INFO] [rook_editor::render::model] Initial tree:
// -------- 0.00px / 0 characters --------
...
fn make_test_cell_layout() -> CellLayout {
    CellLayout {
        ...
        line_caret_positions: vec![vec![
            rookui_core::text_layout::CaretPosition {
...
fn test_link_at_offset_uses_cached_cell_links() {
            ...
            vec![
                ...
                FormattedTextFragment {
                    ...
                    styles: FormattedTextStyles {
                        hyperlink: Some(Hyperlink::Url("https://rook.dev".into())),
                        ..Default::default()
                    },
                },
            ],
    ...
    table.cell_links = vec![
        vec![
            vec![ParsedUrl::new(1..3, "https://rook.dev".into())],
            vec![],
        ],
        vec![vec![], vec![]],
    ];
