...
To test image rendering, open `images/image_test.md` in Rook.
...
To test, open `toc_anchor_test.md` in Rook's Markdown viewer and click the table-of-contents links.
