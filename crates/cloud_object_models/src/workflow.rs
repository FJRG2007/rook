...
/// Workflow model used by Rook and rook-internal.
...
/// Create a rook-internal Workflow model from a public-facing workflow
...
/// Argument model to be used in `rook-internal`
