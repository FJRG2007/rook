...
pub fn hashed_asset_url(hashed_asset_path: &Path) -> String {
    ...
    // - The staging load balancer paths: https://console.cloud.google.com/net-services/loadbalancing/edit/http/serverless-lb?hl=en&project=rook-server-staging
    // - The prod load balancer paths: https://console.cloud.google.com/net-services/loadbalancing/edit/http/app-rook-dev-lb?hl=en&project=astral-field-294621
    format!(
