//! This crate contains generic utilities and helpers available for use across all internal rook
//! crates.
//!
//! Generally, if a given function/abstraction is useful outside of a single rook-internal crate
