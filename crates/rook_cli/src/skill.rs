...
/// - A **simple skill name** - searched across skill directories with precedence (`.agents/skills/`, `.rook/skills/`, `.claude/skills/`, `.codex/skills/`)
...
pub struct SkillSpec {
    ...
    ///
    /// - **Simple name** (e.g., `"code-review"`): Searched across `.agents/skills/`, `.rook/skills/`, `.claude/skills/`, `.codex/skills/`
...
impl SkillSpec {
    ...
    /// skill directories in precedence order (`.agents/skills/`, `.rook/skills/`, `.claude/skills/`, `.codex/skills/`).
    ///
