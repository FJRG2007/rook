...
pub mod regexes {
    ...
    /// Identifies a Rook API Key. Format: wk- followed by a version number and any combination of hex digits, hyphens, or periods.
    pub const ROOK_API_KEY: &str = r"\bwk-[0-9]+\.[A-Fa-f0-9.\-]+\b";
