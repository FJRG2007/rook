...
fn test_firebase_domain() {
    let firebase_domain = "rook-server-staging.firebaseapp.com";
    assert_regex_match_found(regexes::FIREBASE_AUTH_DOMAIN, firebase_domain);

    let bad_firebase_domain = "rook-server-staging_.firebaseapp.com";
...
fn test_ip_address() {
    ...
    let rook_version_number = "v0.2023.08.01.08.04.dev_00";
    ...
    assert_regex_match_not_found(regexes::IPV4_ADDRESS, rook_version_number);
