...
/// A type alias for the concrete type stored within a rookui
...
/// common scheme is reverse-DNS notation (e.g.: "dev.rook.Rook").
#[cfg(not(target_os = "windows"))]
pub fn register(service_name: &str, ctx: &mut rookui_core::AppContext) {
...
pub fn register_noop(service_name: &str, ctx: &mut rookui_core::AppContext) {
...
pub fn register_unavailable(ctx: &mut rookui_core::AppContext) {
...
pub fn register_with_fallback(
    ...
    ctx: &mut rookui_core::AppContext,
) {
...
impl rookui_core::Entity for Model {
    type Event = ();
}

impl rookui_core::SingletonEntity for Model {}
...
impl AppContextExt for rookui_core::AppContext {
    fn secure_storage(&self) -> &dyn SecureStorage {
