...
#
# This script copies resources that should be bundled with Rook into a
...
$AdditionalLicenses = @(
    @{ Name = 'Alacritty (alacritty_terminal)'; License = 'Apache-2.0'; Path = 'crates\rook_terminal\src\model\LICENSE-ALACRITTY' },
