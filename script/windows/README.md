...
a configuration file for building a Rook installer.
...
* Run `cargo build` to ensure the installer uses the latest version of Rook.
...
```shell
.\script\windows\Output\Rook-Windows-Setup.exe
```
